...
{
    public static Task EnsureAsync(SchedulingDbContext db, CancellationToken cancellationToken = default)
    {
    ...
    private const string Sqlite = """
        ...
        CREATE TABLE IF NOT EXISTS "ExternalSchedulingResourceMappings" (
          ...
          "InternalId" TEXT NOT NULL, "ExternalId" TEXT NOT NULL, "CreatedAt" TEXT NOT NULL, "UpdatedAt" TEXT NOT NULL);
