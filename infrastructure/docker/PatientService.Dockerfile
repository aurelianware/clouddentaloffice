...
COPY ["src/Services/PatientService/PatientService.csproj", "src/Services/PatientService/"]
RUN dotnet restore "src/Services/PatientService/PatientService.csproj"
COPY . .
WORKDIR "/src/src/Services/PatientService"
